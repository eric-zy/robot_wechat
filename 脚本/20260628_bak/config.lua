...
local is_debug = true  -- 修改此处切换环境
local api_base_url = is_debug and "http://192.168.1.23:5001" or "http://81.71.47.123:5000"
local ws_base_url = is_debug and "ws://192.168.1.23:8765" or "ws://81.71.47.123:8765"
...
return {
	...
	-- 获取群发任务
	--"/api/mass_send/send?robotCode=" .. tostring(robotCode) .. "&channelNum=" .. tostring(channelNum)
	...
	-- }
	mass_helper_updateStatus_url = api_base_url .. "/api/mass_send/updateStatus",
